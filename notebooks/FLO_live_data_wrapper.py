...
Update <pwd_dir> where .env file is locally stored to access user name
and password to web page in order to download data
...
# define names plotting parameters
...
fig, ax = plot_variometer_data(
        start_time, end_time, obs, base_dir, title, outfile_name, footer, comps
        )
plt.show()
