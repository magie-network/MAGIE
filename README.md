...
pip install "git+https://github.com/magie-network/MAGIE.git@3.1.1"

For alert support with `pip`, install the `alerts` extra:

pip install "magie[alerts] @ git+https://github.com/magie-network/MAGIE.git@3.1.1"

This will install mastodon for mastodon alerts

For magnetometer monitor map support with `pip`, install the `monitor` extra:

pip install "magie[monitor] @ git+https://github.com/magie-network/MAGIE.git@3.1.1"
