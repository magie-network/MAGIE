...
if __name__ == "__main__": # daily update of archive
    ...
    for site_code in ["val", "dun"]:
        ...
        print(kvals)
        print(errors)
        results, errors = daily_K_plots_full_archive(site_code=site_code, archive_path_builder=lambda date: "/magnetometer_archive/{}/{}/{}/k_index/".format(
            *date), output_path_builder=lambda date: "/magnetometer_archive/{}/{}/{}/k_index/".format(
